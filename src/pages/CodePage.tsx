...
const CodePage: React.FC = () => {
  ...
  return (
    <MainLayout
      title="Code Explorer"
      description="Side projects, coding adventures, dan tips pemrograman. Mulai dari web dev hingga embedded systems."
      icon={<Code />}
    ...
    >
      <div className="border-4 border-black bg-zinc-800 rounded-2xl p-6">
        {loading ? (
          ...
          <p className="text-white text-xl py-10">No Code posts found. Check back later!</p>
        )}
