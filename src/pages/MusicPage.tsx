...
const MusicPage: React.FC = () => {
  ...
  return (
    <MainLayout
      title="Music Corner"
      description="Musik, gitar, sound engineering, dan hal-hal auditory lainnya yang membuat saya tertarik."
      icon={<Music />}
    ...
    >
      <div className="border-4 border-black bg-zinc-800 rounded-2xl p-6 text-center">
        {loading ? (
          ...
          <p className="text-white text-xl py-10">No Music posts found. Check back later!</p>
        )}
